...
- **Geodesy:** geodesic direct and inverse problems on the ellipsoid (Karney), and an epoch-aware terrestrial reference frame catalog with published ITRF and ETRF Helmert parameter sets.
