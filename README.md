...
- [`sidereon`](crates/sidereon): the ergonomic Rust interface over `sidereon-core`. Product loaders plus SPP/RTK/PPP/static solves with result structs and one error enum. This is the Rust interface, held to the same parity bar as the bindings below.
